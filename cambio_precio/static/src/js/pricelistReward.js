    ...
    _updateRewards() {
        ...
        if (pricelistReward) {
            if (!this._originalPricelistId) {
                this._originalPricelistId = this.pricelist ? this.pricelist.id : null;

                if(this.pricelist.id == this._originalPricelistId) {
                    this._originalPricelistId = 1;
                }
        ...
        } else if (this._originalPricelistId) {
            const original = this.pos.pricelists.find(p => p.id === this._originalPricelistId);
            if (original && (!this.pricelist || this.pricelist.id !== original.id)) {
